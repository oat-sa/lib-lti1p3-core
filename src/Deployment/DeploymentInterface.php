...
use OAT\Library\Lti1p3Core\Security\Key\KeySetInterface;
...
interface DeploymentInterface
{
    ...
    public function getToolKeyPair(): KeySetInterface;

    public function getPlatformKeyPair(): ?KeySetInterface;
}
