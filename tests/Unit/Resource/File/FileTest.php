...
namespace OAT\Library\Lti1p3Core\Tests\Unit\Resource\File;
...
class FileTest extends TestCase
{
    ...
    public function testItImplementsFileInterface(): void
    {
        $this->assertInstanceOf(FileInterface::class, $this->subject);
    }
    ...
    public function testPropertiesGetters(): void
    {
        ...
        $this->assertEquals('expiresAt', $this->subject->expiresAt());
    }
}
